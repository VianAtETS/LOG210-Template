...
Welcome to the **LOG210-Template** repository! This repository was generated from a template to get you started quickly.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/VianAtETS/LOG210-Template.git
   cd LOG210-Template
   ```
